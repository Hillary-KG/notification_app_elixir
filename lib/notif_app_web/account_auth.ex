defmodule NotifAppWeb.AccountAuth do
  use NotifAppWeb, :verified_routes
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_notif_app_web_account_remember_me"
  ...
  def log_out_account(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      NotifAppWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_account:
      ...
      defmodule NotifAppWeb.PageLive do
        use NotifAppWeb, :live_view

        on_mount {NotifAppWeb.AccountAuth, :mount_current_account}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{NotifAppWeb.AccountAuth, :ensure_authenticated}] do
