defmodule NotifAppWeb.AccountAuthTest do
  use NotifAppWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias NotifApp.Accounts
  alias NotifAppWeb.AccountAuth
  import NotifApp.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, NotifAppWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_account/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      NotifAppWeb.Endpoint.subscribe(live_socket_id)
