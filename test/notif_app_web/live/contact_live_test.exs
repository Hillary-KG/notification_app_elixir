defmodule NotifAppWeb.ContactLiveTest do
  use NotifAppWeb.ConnCase

  import Phoenix.LiveViewTest
  import NotifApp.ContactsFixtures

  @create_attrs %{email_address: "some email_address", first_name: "some first_name", last_name: "some last_name"}
  ...
  describe "Index" do
    ...
    test "lists all contacts", %{conn: conn, contact: contact} do
      ...
      assert html =~ contact.email_address
    end
