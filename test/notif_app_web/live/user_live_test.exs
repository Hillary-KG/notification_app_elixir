defmodule NotifAppWeb.UserLiveTest do
  use NotifAppWeb.ConnCase

  import Phoenix.LiveViewTest
  import NotifApp.UsersFixtures

  @create_attrs %{bio: "some bio", contacts: ["option1", "option2"], dob: "2024-05-14", first_name: "some first_name", last_name: "some last_name", msisdn: "some msisdn", plan: "some plan", status: "some status"}
  @update_attrs %{bio: "some updated bio", contacts: ["option1"], dob: "2024-05-15", first_name: "some updated first_name", last_name: "some updated last_name", msisdn: "some updated msisdn", plan: "some updated plan", status: "some updated status"}
  @invalid_attrs %{bio: nil, contacts: [], dob: nil, first_name: nil, last_name: nil, msisdn: nil, plan: nil, status: nil}
